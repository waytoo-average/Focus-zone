...
class _QuranEntryScreenState extends State<QuranEntryScreen> {
  ...
  Future<void> _loadCachedQuranInfo() async {
    ...
    setState(() {
      ...
      _expectedFileCount = info['pageCount'] ?? 0;
      final mb = ((info['fileSize'] ?? 0) / (1024 * 1024)).toStringAsFixed(1);
      _expectedSize = mb == '0.0' ? 'Unknown' : '${mb}MB';
    ...
    return Directionality(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, _) {
          final state = _manager.state;
          final isDownloaded =
              _isDownloadedCached || state.status == DownloadStatus.completed;
                      ...
                      _ModernQuranCard(
                        ...
                        subtitle: isDownloaded
                            ...
                            : isDownloading || isPaused
                                ...
                                : _isLoadingSize
                                    ? "Loading..."
                                    : "Complete Quran ($_expectedSize, $_expectedFileCount pages)",
                        color: isDownloaded
                          ...
                          children: [
                            ...
                            Text(
                              state.status == DownloadStatus.pausing
                                  ? s.pausingPleaseWait
                                  : state.status == DownloadStatus.cancelling
                                      ? s.cancellingPleaseWait
                                      : s.deletingPleaseWait,
                              style: TextStyle(
                                color: theme.textTheme.bodyMedium?.color,
                                fontSize: 15,
                              ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${state.downloadedFiles} of ${state.totalFiles} pages downloaded',
                                      style: TextStyle(
                                        color:
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  state.errorMessage ?? s.anErrorOccurred,
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: Text(isPaused ? s.resumeDownload : s.pauseDownload),
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            isPaused ? s.pauseDownload : s.downloading,
                            style: TextStyle(
                              fontSize: 14,
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          icon: Icon(isPaused ? Icons.play_arrow : Icons.pause),
                          label: Text(
                              isPaused ? s.resumeDownload : s.pauseDownload),
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
