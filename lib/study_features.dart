...
const Map<String, Map<String, Map<String, Map<String, Map<String, String>>>>> allAcademicContentFolders = {
  'First Grade': { // Grade
...
class SemesterSelectionScreen extends StatelessWidget {
  ...
  Map<String, String> _getSubjectsForContext(BuildContext context, AcademicContext contextToLookup) {
    ...
    final Map<String, Map<String, Map<String, Map<String, String>>>>? gradeMap = allAcademicContentFolders[canonicalGrade];
          ...
          Expanded(
            child: _isLoading
              ...
              child: Padding(
                ...
                ? _buildEmptyState(Icons.folder_open_outlined, s!.noFilesIllustrationText)
                : ListView.builder(
